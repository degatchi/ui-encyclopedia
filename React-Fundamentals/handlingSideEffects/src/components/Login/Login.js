...
const Login = () => {
  ...
  useEffect(() => {
    ...
    // Doesn't trigger on initial instance; however, triggers first on all other instances
    return () => {
      console.log('CLEANUP');
      clearTimeout(identifier);
    };
  }, [emailIsValid, passwordIsValid]); // re-runs `setFormIsValid` whenever the dependencies change.
